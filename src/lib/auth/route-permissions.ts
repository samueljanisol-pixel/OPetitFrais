...
const rules: RouteRule[] = [
  ...
  { match: (p) => p.startsWith("/clients"), permission: "clients.read" },
  { match: (p) => p.startsWith("/commandes-client/preparation"), permission: "commandes_client.prepare" },
  { match: (p) => p.startsWith("/commandes-client/livraison"), permission: "commandes_client.deliver" },
  { match: (p) => p.startsWith("/commandes-client/retrait"), permission: "commandes_client.deliver" },
  { match: (p) => p.startsWith("/commandes-client"), permission: "commandes_client.read" },
  { match: (p) => p.startsWith("/historique-ca") || p.startsWith("/ca") || p.startsWith("/analyse-stats") || p.startsWith("/clotures"), permission: "ventes.read" },
