...
export const PRODUCT_SHEET_EXPORT_SELECT = `code, name, price, margin, active, name_ar, ref_sales_unit (label), ref_category (label), ref_subcategory (label), ${PRODUCT_PRIMARY_SUPPLIER_EMBED} (label)`;
