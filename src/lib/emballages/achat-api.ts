import type { EmballageAchatFicheRow, EmballageAchatLigneRow, EmballageRefRelation } from "@/lib/emballages/types";
import { emballageAchatLigneMontant, isEmballageStatutFiche, normalizeEmballageRef } from "@/lib/emballages/types";
...
export const FICHE_SELECT = "id, date_achat, statut, note, cloture_at, created_at, updated_at";
export const LIGNE_SELECT =
  "id, fiche_id, emballage_id, quantite, prix_unitaire, note, sort_order, created_at, updated_at, ref_emballage(id, label, ref_emballage_type(id, label))";
