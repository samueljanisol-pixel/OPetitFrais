...
- **Sélection** : cases à cocher + **Valider la sélection** / **Ne rien faire** (retire de la file sans modifier le produit) sur chaque liste. Icône édition → fiche produit (`returnTo` = cette page).
