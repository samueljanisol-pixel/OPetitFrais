...
- **Graphique** : histogramme SVG journalier — bascule **Tri CA** / **Tri qté** / **Tri bénéfice**. Clic sur une barre pour afficher la valeur ; zoom par boutons Zoom +/− ; courbe de tendance (moyenne mobile lissée).
