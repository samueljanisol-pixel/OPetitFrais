...
import { formatCashierClock, formatMagasinCaisseLabel, useClock } from "../lib/status-bar";
...
export default function CaisseClosedScreen({
  ...
  return (
    ...
    >
      ...
      <Typography sx={{ fontVariantNumeric: "tabular-nums", color: "text.secondary", mb: 1.5 }}>
      ...
      >
        ...
        >
          ...
          <RoundNumpad keys={PIN_KEYS} onKey={handleKey} keySize={56} disabled={busy} />
          {error ? (
          ...
          <Button
            ...
            disabled={busy}
            onClick={() => void submit()}
            sx={{ mt: 1.5, py: 1.4, fontWeight: 800 }}
          >
